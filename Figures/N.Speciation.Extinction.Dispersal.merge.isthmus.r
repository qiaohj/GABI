...
if (F){
  sp.with.bridge<-readRDS("../Data/Tables/sp_full_continents.merge.isthmus.rda")
  sp.with.bridge[previous_continent %in% c("bridge1", "bridge2") & 
                   type=="New.Immigrants" & current_continent==seed_continent,
                 type:="Still.There"]
  ...
  saveRDS(final.df, "../Data/Tables/N.with.bridge.seed.continent.merge.isthmus.rda")
...
to.doc(dispersal.all.se, "Number of dispersal events", 
       "../Figures/N.Speciation.Extinction.Dispersal/N.Dispersal.merge.isthmus.docx",
       digits=2)
ggsave(p, filename="../Figures/N.Speciation.Extinction.Dispersal/N.Dispersal.merge.isthmus.pdf", width=5, height=3)
ggsave(p, filename="../Figures/N.Speciation.Extinction.Dispersal/N.Dispersal.merge.isthmus.png", width=5, height=3, bg="white")
...
to.doc(all.df.se, "Number of speciation and extinction events, and species richness", 
       "../Figures/N.Speciation.Extinction.Dispersal/N.Speciation.Extinction.Richness.merge.isthmus.docx",
       digits=2)
ggsave(p, filename="../Figures/N.Speciation.Extinction.Dispersal/N.Speciation.Extinction.Richness.merge.isthmus.pdf", 
       width=10, height=3)
ggsave(p, filename="../Figures/N.Speciation.Extinction.Dispersal/N.Speciation.Extinction.Richness.merge.isthmus.png", 
...
to.doc(dispersal.all.se, "Number of dispersal events", 
       "../Figures/N.Speciation.Extinction.Dispersal/N.Dispersal.details.merge.isthmus.docx",
       digits=2)
ggsave(p, filename="../Figures/N.Speciation.Extinction.Dispersal/N.Dispersal.details.merge.isthmus.pdf", width=10, height=5)
ggsave(p, filename="../Figures/N.Speciation.Extinction.Dispersal/N.Dispersal.details.merge.isthmus.png", width=10, height=5, bg="white")
...
to.doc(all.df.se, "Number of speciation and extinction events, and species richness", 
       "../Figures/N.Speciation.Extinction.Dispersal/N.Speciation.Extinction.Richness.details.merge.isthmus.docx",
       digits=2)
ggsave(p, filename="../Figures/N.Speciation.Extinction.Dispersal/N.Speciation.Extinction.Richness.details.merge.isthmus.pdf", 
       width=15, height=5)
ggsave(p, filename="../Figures/N.Speciation.Extinction.Dispersal/N.Speciation.Extinction.Richness.details.merge.isthmus.png", 

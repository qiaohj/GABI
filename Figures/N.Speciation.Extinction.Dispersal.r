...
to.doc(dispersal.all.se, "Number of dispersal events", 
       ...
       digits=2)
ggsave(p.disp, 
       filename="../Figures/N.Speciation.Extinction.Dispersal/Simulation.remove.outliers/N.Dispersal.details.pdf", 
       width=10, height=5)
ggsave(p.disp, 
       filename="../Figures/N.Speciation.Extinction.Dispersal/Simulation.remove.outliers/N.Dispersal.details.png", 
...
to.doc(dispersal.all.se, "Number of dispersal events by seed", 
       ...
       digits=2)
ggsave(p.disp.seed, 
       filename="../Figures/N.Speciation.Extinction.Dispersal/Simulation.remove.outliers/N.Dispersal.Seed.details.pdf", 
       width=6, height=3)
ggsave(p.disp.seed, 
       filename="../Figures/N.Speciation.Extinction.Dispersal/Simulation.remove.outliers/N.Dispersal.Seed.details.png", 

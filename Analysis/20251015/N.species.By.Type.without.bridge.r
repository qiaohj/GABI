...
if (F){
  ...
  species.type.N<-readRDS("../Data/Tables/100k.speciation.years/species.type.N.without.bridge.rda")
  ...
  if (F){
    fwrite(combinations, 
           "../Data/full.combination.without.bridge.csv")
  }
  
  ##Detect the type of species
  combinations<-fread( "../Data/full.combination.without.bridge.csv")
  i=1
  ...
  fwrite(event.N, 
         "../Data/full.event.N.without.bridge.csv")
  ...
  saveRDS(sp_full_continents, "../Data/Tables/100k.speciation.years/sp_full_continents.without.bridge.rda")
}

sp_full_continents<-readRDS("../Data/Tables/100k.speciation.years/sp_full_continents.without.bridge.rda")
...
saveRDS(delta_Species.df, "../Data/Tables/100k.speciation.years/delta_Species.without.bridge.rda")
saveRDS(type_N.df, "../Data/Tables/100k.speciation.years/type_N.without.bridge.rda")
...
saveRDS(delta_Species.origin.df, "../Data/Tables/100k.speciation.years/delta_Species.origin.without.bridge.rda")
saveRDS(type_N.origin.df, "../Data/Tables/100k.speciation.years/type_N.origin.without.bridge.rda")

...
saveRDS(rep.df.all, "../Data/Tables/Lat.low.high.without.bridges.NULL.rda")
saveRDS(rep.df, "../Data/Tables/Lat.low.high.without.bridges.nb.da.NULL.rda")

rep.df2<-rbindlist(rep.list2)
rep.df.all2<-rbindlist(rep.list.all2)
saveRDS(rep.df.all2, "../Data/Tables/Lat.low.mid.high.without.bridges.NULL.rda")
saveRDS(rep.df2, "../Data/Tables/Lat.low.mid.high.without.bridges.nb.da.NULL.rda")

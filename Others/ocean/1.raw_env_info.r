...
source<-"../Data/3600Ma_simulations_ocean/3600Ma_simulations"
...
all$label<-gsub("../Data/3600Ma_simulations_ocean/3600Ma_simulations/", "", all$folder)
all_age<-merge(all, year_labels, by="label")
fwrite(all_age, "../Data/3600Ma_simulations_ocean/meta_table.csv")
saveRDS(all_age, "../Data/3600Ma_simulations_ocean/meta_table.rda")
